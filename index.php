...
<head>
    ...
    <title>Send Messages to Whatsapp Numbers without saving them to your contacts</title>
    <meta name="theme-color" content="#00a42e">
    <meta name="twitter:description" content="Simply put your phone number and text to have Whatsapp open the App with the message prefilled and ready to send to the phone number you specified!">
    <meta name="twitter:image" content="https://qodestone.dev/whatsapp-sender/assets/img/web logo Qudostone.png">
    <meta property="og:image" content="https://qodestone.dev/whatsapp-sender/assets/img/Favicon 32.png">
    <meta name="description" content="Simply put your phone number and text to have Whatsapp open the App with the message prefilled and ready to send to the phone number you specified!">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Send Messages to Whatsapp Numbers without saving them to your contacts">
    <link rel="icon" type="image/png" sizes="2000x2000" href="assets/img/Favicon%2032.png">
    <link rel="icon" type="image/png" sizes="2000x2000" href="assets/img/Favicon%2032.png">
    <link rel="icon" type="image/png" sizes="2000x2000" href="assets/img/Favicon%2032.png">
    <link rel="icon" type="image/png" sizes="2000x2000" href="assets/img/Favicon%2032.png">
    <link rel="icon" type="image/png" sizes="2000x2000" href="assets/img/Favicon%2032.png">
...
<body>
        ...
        <div class="container"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav flex-grow-1 justify-content-between">
                    <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-whatsapp apple-logo"></i></a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Send a message to Whatsapp Phone Numbers without saving to contacts.</a></li>
    ...
    <section class="login-dark">
        <form method="post" action="process.php">
            ...
            <div class="illustration" style="color: rgb(0,140,81);"><i class="icon ion-social-whatsapp-outline"></i></div>
            <input type="checkbox" checked="" name="use_web" data-onstyle="success" data-offstyle="danger" data-on="Yes" data-off="No" data-bs-toggle="toggle"><small>&nbsp;Use Whatsapp Web</small>
            <div class="mb-3 country"><a class="forgot" href="#" style="color: rgb(0,247,143);">Untick the checkbox above if u are visiting with a smartphone or If you wish to use the Whatsapp Desktop App</a>
                <small>Country Code</small>
                <select class="js-example-basic-single" style="width: 90%" id="countryCode" name="countryCode">
                    <option></option>
            ...
            <input class="form-control" type="tel" name="number" placeholder="Phone Number"></div>
            <div class="mb-3"><input class="form-control" type="text" name="message" placeholder="Message"></div>
            <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" style="background: rgb(0,140,81);">Send Message</button></div>
        </form>
    </section>
